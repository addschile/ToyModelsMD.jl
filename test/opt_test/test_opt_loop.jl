...
vsigt[:] .*= dt^2
# initialize value baseline coefficients 
...
for i in 1:nepochs
  ...
  softmcvb.vbl.cs += (lrv .* gradv)
  writedlm("init_running_coeffF.txt",model.potentials[2].cs)
  writedlm("init_running_coeffV.txt",softmcvb.vbl.cs)
end
